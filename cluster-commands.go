...
func (adm *AdminClient) ClusterReplicateAdd(ctx context.Context, addArg CRAdd) error {
	...
	reqData := requestData{
		relPath: adminAPIPrefix + "/cluster-replicate/add",
		content: eCRAddBytes,
	}
...
func (adm *AdminClient) ClusterReplicateInfo(ctx context.Context) (info ClusterReplicateInfo, err error) {
	reqData := requestData{
		relPath: adminAPIPrefix + "/cluster-replicate/info",
	}
...
func (adm *AdminClient) CRInternalJoin(ctx context.Context, r CRInternalJoinReq) error {
	...
	reqData := requestData{
		relPath: adminAPIPrefix + "/cluster-replicate/peer/join",
		content: encBuf,
	}
...
func (adm *AdminClient) CRInternalBucketOps(ctx context.Context, bucket string, op BktOp, opts map[string]string) error {
	...
	reqData := requestData{
		queryValues: v,
		relPath:     adminAPIPrefix + "/cluster-replicate/peer/bucket-ops",
	}
...
type CRSvcAccCreate struct {
	...
	SessionPolicy *iampolicy.Policy `json:"sessionPolicy"`
...
func (adm *AdminClient) CRInternalReplicateIAMItem(ctx context.Context, item CRIAMItem) error {
	...
	reqData := requestData{
		relPath: adminAPIPrefix + "/cluster-replicate/peer/iam-item",
		content: b,
	}
...
func (adm *AdminClient) CRInternalReplicateBucketMeta(ctx context.Context, item CRBucketMeta) error {
	...
	reqData := requestData{
		relPath: adminAPIPrefix + "/cluster-replicate/peer/bucket-meta",
		content: b,
	}
